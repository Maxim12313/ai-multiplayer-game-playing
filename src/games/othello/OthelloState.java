...
public class OthelloState extends State {
    ...
    public OthelloState(Side newSideToPlay,OthelloState prevState){
        super(newSideToPlay);
        this.black = prevState.black;
        this.white = prevState.white;
        this.numPassedMoves = prevState.numPassedMoves;
    }
